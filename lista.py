        ...
        with open(OUTPUT_FILE, "w", encoding="utf-8") as f:
            ...
            for category, channels_list in organized_channels.items():
                ...
                for ch in channels_list:
                    ...
                    elif not channel_display_name.upper().endswith(" (2)"): # Assumed Vavoo
                        url_with_specific_headers += vavoo_headers_str
                    # Manual (2) channels already have headers in base_stream_url
